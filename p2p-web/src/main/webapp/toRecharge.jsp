...
function submitForm () {
	...
	if (checkData()) {
		...
		//判断支付类型
        if("alipay" == payType){
            $("#alipayRechargeMoney").val($.trim($("#rechargeMoney").val()));
            $("#aliPayRechargeForm").submit();
        }else {
            $("#wxpayRechargeMoney").val($.trim($("#rechargeMoney").val()));
          ...
          <div class="investMain">
            ...
            <div class="investContent">
              ...
              <div class="investOver clearfix" id = "banks2">
                  ...
                  <form id="aliPayRechargeForm" action="${pageContext.request.contextPath}/loan/toRecharge" method="post"
                        target="_blank">
                      <input type="hidden" name="rechargeMoney" id="alipayRechargeMoney" value=""/>
                  </form>
                  <label>
                  ...
                  <form id="wxPayRechargeForm" action="${pageContext.request.contextPath}/loan/toWXpayRecharge" method="post"
                        target="_blank">
                      <input type="hidden" name="rechargeMoney" id="wxpayRechargeMoney" value=""/>
                  </form>
                  <label>
