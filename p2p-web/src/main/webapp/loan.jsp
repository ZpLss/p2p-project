	...
	<div class="right-side">
	    <div class="side-box fixed" id="roll" style="top: 0px;">
	        ...
	        <div class="system-notice" style="margin-top: 0px;">
	            ...
	            <ul>
	            <c:forEach items="${userTopList}" var="topUser" varStatus="index">
	            	<li><span>${index.count}.&nbsp;${fn:substring(topUser.phone,0,3 )}****${fn:substring(topUser.phone,7,11)}&nbsp;&nbsp;${topUser.score}</span></li>
	            </c:forEach>
	            </ul>
	        </div>
	        <!--投资排行榜end-->
