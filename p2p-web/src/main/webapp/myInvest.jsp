     ...
     <div class="deal-data">
      <dl>
       ...
       <span class="deal-money">投资金额(元)</span>
		  ...
		  <c:forEach items="${dataList}" var="bidInfo" varStatus="index" >
			  <dd>
				  <div class="deal-time"><fmt:formatDate value="${bidInfo.bidTime}" pattern="yyyy-MM-dd HH:ss:mm"></fmt:formatDate></div>
