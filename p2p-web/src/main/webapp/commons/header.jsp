        ...
        <div class="login-right">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <a href="loan/myCenter" class="user-phone">${empty user.name?user.phone:user.name}</a><a href="/webPage/account/member_systems.html" class="user-vip" id="member">VIP1</a><i></i>
                    </div>
