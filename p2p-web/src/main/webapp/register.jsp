        ...
        <div class="fl">
            ...
            <div class="login-form reg-form">
              ...
              <div class="login-box clearfix" style="z-index:80;">
                <label>确认密码</label>
                <input type="password" id="replayLoginPassword" name="replayLoginPassword" class="input_text" maxlength="21"
                       placeholder="请再次输入登录密码" onblur="checkReplayLoginPassword()"/>
