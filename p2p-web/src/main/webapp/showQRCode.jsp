...
<head>
    ...
    <script type="text/javascript" language="javascript"
            src="js/trafficStatistics.js"></script>
</head>
        ...
        <div class="fund-guanli clearfix">
            ...
            <div class="right-body">
                ...
                <div class="unrecognized" style="display:block;" id="unrecognized1">
                    <h3>微信支付: 充值金额 ${rechargeMoney} &nbsp;&nbsp;&nbsp; 充值订单号 ${rechargeNo} &nbsp;&nbsp;&nbsp; 充值时间 <fmt:formatDate value="${rechargeTime}" pattern="yyyy-MM-dd HH:mm:ss"/></h3>

                    <img src="loan/generateQRCode?out_trade_no=${rechargeNo}&rechargeMoney=${rechargeMoney}&d=" + new Date() />
                </div>
