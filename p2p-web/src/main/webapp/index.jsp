...
<div id="productArea">
            ...
            <div class="inner">
                ...
                <div class="index-exper-bottom">
                    <ul class="list cf">
                        ...
                        <li class="box4">
                            <a href="loan/loanInfo?loanId=${xLoanInfo.id}" class="go-invest">立即投资</a>
                        </li>
                    </ul>
                </div>
            </div>
	...
	<div class="mainBox pro-body clearfix">
	    <c:forEach items="${yLoanInfoList}" var="yLoanInfo">
            <!-- 1:已满标时class样式追加 pro-full-->
            <div class="pro-box <c:if test="${yLoanInfo.leftProductMoney == 0}">pro-full</c:if>  ">
                <div class="pro-top">
                    <h3>${yLoanInfo.productName}</h3>
                    <p>短期小额信用借款集合投资计划</p>
                </div>
                <div class="pro-main">
                    <div class="pro-rate">
                        <div class="rate">
                            ${yLoanInfo.rate}<span>%</span>
                        </div>
                        <h3>历史年化收益率</h3>
                    </div>
                    <div class="pro-data clearfix">
                        <div class="pro-cycle">
                            <h3>投资周期</h3>
                            <div class="data"><span>${yLoanInfo.cycle}</span>个月</div>
                        </div>
                        <div class="pro-money">
                            <h3>剩余可投金额</h3>
                            <div class="data">
                                <span>${yLoanInfo.leftProductMoney}</span>元
                            </div>
                        </div>
                    </div>
                    <div class="pro-intr"><p>优选计划项目，投资回报周期1个月，起点低，适合短期资金周转、对流动性要求高的投资人。</p></div>
                    <div class="pro-btn">
                        <a href="loan/loanInfo?loanId=${yLoanInfo.id}" class="btn-1">立即投资</a>
                    </div>
                </div>
            </div>
        </c:forEach>
	...
	<div class="mainBox pro-body disperse-pro clearfix">
        ...
        <c:forEach items="${sLoanInfoList}" var="sLoanInfo" varStatus="index">
            ...
            <!-- 4个一组，分隔线 -->
            <c:if test="${index.count eq 4}"><div style="line-height:25px;">&nbsp;</div></c:if>
        </c:forEach>
	</div>
